# Retrieve the league's win/loss records

In this tutorial:

- You will learn how to retrieve the league's win/loss records from the Rec Hockey Service using both
curl and Postman Desktop
- You will be introduced to some common errors and troubleshooting tips

## Table of Contents
- [Prerequisites](#1)
- [Retrieve the records using curl](#2)
- [Retrieve the records using Postman Desktop](#3)
...
<a id="2"></a>
## Retrieve the records using curl
...
<a id="3"></a>
## Retrieve the records using Postman Desktop
